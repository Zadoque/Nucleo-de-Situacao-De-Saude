...
CATEGORIAS_CONSULTA = {
    "data": "DT_NOTIFIC", "estado": "SG_UF_NOT", "cidade": "SG_UF_NOT",
    "ano de nascimento": "ANO_NASC", "sexo": "CS_SEXO"
}

def interest_columns(lst: list):
    if lst is None:
        raise ValueError("Colunas de interesse não preenchidas")

    for col in lst:
        INTEREST_COLUMNS.append(CATEGORIAS_CONSULTA[col])
